      ...
      <div className="max-w-7xl mx-auto rounded-2xl bg-white border-[2.5px] border-black shadow-[4px_4px_0px_0px_#000000] px-4 sm:px-6 h-16 flex items-center justify-between transition-all duration-200">
        <div className="flex items-center gap-6">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="font-black text-base tracking-tight text-stone-900 group-hover:text-[#ff0844] transition-colors">
          ...
          <nav className="hidden md:flex items-center gap-2 pl-5 border-l-2 border-black">
            <Link
              to="/"
